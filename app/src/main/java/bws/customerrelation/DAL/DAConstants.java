...
public class DAConstants {
    ...
    public static String TABLE_CLIENT= "tb_client";
    public static String TABLE_CLIENTLIST = "tb_list";
//    public static String TABLE_HIDDEN_POST = "tb_hidden_post";
//    public static String TABLE_MESSAGE = "tb_message";
